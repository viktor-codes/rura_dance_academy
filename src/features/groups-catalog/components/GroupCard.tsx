...
export function GroupCard({ style }: GroupCardProps) {
  ...
  return (
    <motion.article
      ...
      className="relative flex h-full min-h-[480px] z-[100000] flex-col overflow-hidden rounded-lg border border-border bg-white shadow-sm transition-colors focus-within:ring-2 focus-within:ring-sense-rose focus-within:ring-offset-2 hover:border-sense-rose"
    >
      {hasImage && (
        <div
